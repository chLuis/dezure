...
export default function Conversation({ data }: ConversationProps) {
  ...
  return (
    <div className="w-full relative bg-neutral-900 px-2 lg:px-4 lg:my-2 max-w-[960px] flex flex-col justify-between items-center min-h-screen gap-2 pb-32 overflow-clip">
